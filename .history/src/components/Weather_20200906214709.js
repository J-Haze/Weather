                ...
                <div id="results-card">
                    ...
                    <div className="row">
                        ...
                        <div className="other-container">
                            <div className="wind other"><img src={weatherIcons['200']} className="windy" alt="Wind Icon" />2.7{wind} km/h</div>
                            ...
                            <div className="humidity other">
                                <img src={weatherIcons['400']} className="windy" alt="Wind Icon" /> 77{humidity} %</div>
                        </div>
                    </div>
                </div>
            </div>
