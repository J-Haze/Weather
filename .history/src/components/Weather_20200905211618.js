    ...
    function GetWeather(location) {
        ...
        async function fetchWeatherData(url) {
            ...
            try {
                ...
                if (dataResponse.cod !== 200) throw new Error(`${dataResponse.cod}: ${dataResponse.message}`);
                setData(dataResponse);
                console.log("setData1:", dataResponse)
            ...
            await console.log("Data4:", data)
            return dataResponse
        };
        setData(fetchWeatherData(url))
