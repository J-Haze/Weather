                ...
                <div id="results-card">
                    ...
                    <div className="row">
                        <div className="temp-container">
                            <div className="temp">15&#176; {temp}</div>
                            <div className="feel">Feels Like 13&#176; {feel}</div>
                            <div className="max">High: 17&#176; {max}</div>
                            <div className="min">Low: 12&#176; {min}</div>

                        </div>

                        <div className="weather-container">
                            <div className="weather"> Weather: {weather} </div>
                            <div className="icon"><img src={weatherIcons[icon]} /></div>
