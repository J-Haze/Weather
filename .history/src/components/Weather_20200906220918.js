                ...
                <div id="results-card">
                    ...
                    <div className="row">
                        <div className="temp-container">
                            ...
                            <div className="feel temp">Feels like {feel}&#176; </div>
                            <div className="max temp">High: {max}&#176; </div>
                            <div className="min temp">Low: {min}&#176; </div>
                        ...
                        <div className="other-container">
                            <div className="wind other"><img src={weatherIcons['200']} className="windy" alt="Wind Icon" />{wind} {unit == "imperial" ? 'mph' : 'km/h'}</div>
