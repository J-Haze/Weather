                ...
                <div id="results-card">
                    ...
                    <div className="row">
                        ...
                        <div className="other-container">
                            <div className="wind"><img src={'..assets/icons/wind.png'} className="icon" alt="Weather Icon"/>2.7{wind} km/h</div>
                            <div className="pressure">
                                <i className="fas fa-tachometer-alt" alt-label="pressure" />1022  {pressure} hPa
                            </div>
                            <div className="humidity">
                                <i className="fas fa-tint" alt-label="humidity" /> 77{humidity} %</div>
                        </div>
                    </div>
                </div>
            </div>
